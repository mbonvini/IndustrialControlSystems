...
info="
  ...
  <h4>Description</h4>
  <p>
  Model of comparison for Integer numbers.<br>
  The output <FONT FACE=Courier>y</FONT> is true if the inputs <FONT FACE=Courier>u1</FONT> is less or equal than <FONT FACE=Courier>u2</FONT>.
  </p>
  <p>

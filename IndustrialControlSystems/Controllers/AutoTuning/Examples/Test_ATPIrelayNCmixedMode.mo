...
model Test_ATPIrelayNCmixedMode
  ...
  Modelica.Blocks.Math.Feedback sum2 annotation (Placement(transformation(
          extent={{20,-70},{40,-50}},
                                    rotation=0)));
equation
  connect(SP.y, ControllerPm45.SP) annotation (Line(points={{-79,72},{-54,
          72},{-54,59.2},{-37.4,59.2}},
        color={0,0,127}));
  connect(sum.y, ProcessPm45.u)    annotation (Line(points={{43,36},{43,36},{56.6,
          36}},
        color={0,0,127}));
  connect(ProcessPm45.y, ControllerPm45.PV)
                                      annotation (Line(points={{78.7,36},
          {86,36},{86,12},{-46,12},{-46,50.8},{-37.4,50.8}},
                                              color={0,0,127}));
  ...
  connect(ProcessPm60.y, ControllerPm60.PV) annotation (Line(
      points={{78.7,-10},{84,-10},{84,-40},{-46,-40},{-46,-11.2},{-37.4,
          -11.2}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  <h4>Description</h4>
  <p>
  In this example have been tested the functionalities of the mixed mode PI with Automatic Tuning.<br>
  ...
  <img src=\"modelica://IndustrialControlSystems/help/images/Controllers/AutoTuning/Examples/ATPI_mm_PV.png\"><br>
  Control signals
  <img src=\"modelica://IndustrialControlSystems/help/images/Controllers/AutoTuning/Examples/ATPI_mm_CS.png\"><br>

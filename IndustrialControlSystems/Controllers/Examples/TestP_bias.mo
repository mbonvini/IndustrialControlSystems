...
model TestP_bias "Test of the Proportional controller with bias"
  ...
  Modelica.Blocks.Math.Feedback sub2
        ...
        rotation=0,
        origin={-16,50})));
  IndustrialControlSystems.Controllers.P R_Bias(
    useBIAS=true,
    AntiWindup=true,
    CSmin=0,
    CSmax=2,
...
<dd><i>The IndustrialControlSystems package is <b>free</b> software; it can be redistributed and/or modified under the terms of the <b>Modelica license</b>.</i><br/></dd>
  ...
  <h4>Description</h4>
  <p>
  In this example have been tested the proportional controller.<br>

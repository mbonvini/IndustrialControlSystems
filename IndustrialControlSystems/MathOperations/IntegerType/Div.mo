...
equation
  ...
  annotation (Icon(graphics={Text(
          extent={{-38,28},{54,-22}},
          lineColor={0,0,0},
          textString="div")}),Documentation(
info="
  <HTML>
  <h4>Description</h4>
  <p>
  Model of the integer division difference of two integers.<br>
  The output ( <FONT FACE=Courier>y</FONT> ) is the integer division of the inputs ( <FONT FACE=Courier>u1</FONT>, <FONT FACE=Courier>u2</FONT> ) signals.
  <pre>
    y = div(u1,u2)
  </pre>
  <br>

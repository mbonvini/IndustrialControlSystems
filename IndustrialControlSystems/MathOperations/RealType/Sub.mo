...
model Sub "Difference of two real numbers"
  extends
...
equation
  ...
  The output ( <FONT FACE=Courier>y</FONT> ) is the difference of the inputs ( <FONT FACE=Courier>u1</FONT>, <FONT FACE=Courier>u2</FONT> ) signals.
  <pre>
    y = u1 - u2
  </pre>
  </p>

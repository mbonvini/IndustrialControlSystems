...
info="
  ...
  <p>
   ...
   <ul>
   <li>as continuous-time equations,</li>
   <li>as equations but evolving by events, and </li>
   <li>when multiple assignments could not be avoided, although research to solve this is underway – as algorithms.</li>
   </ul><br>
